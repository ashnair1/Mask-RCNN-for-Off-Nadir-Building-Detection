...
CROWDAI_MODEL_PATH = os.path.join(ROOT_DIR, "crowdai_pretrained_weights.h5")
...
if __name__ == '__main__':
    ...
    elif args.model.lower() == "crowdai":
        # Find last trained weights
        model_path = CROWDAI_MODEL_PATH
    ...
    if args.command == "train":
        ...
        val_type = "val" if args.year in '2018' else "minival"
